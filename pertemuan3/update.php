...
<body>
	<div class="wrapper">
		<div>
			...
			$script = "SELECT * FROM buku WHERE book_id = $book_id";
			...
			if (isset($_POST['submit'])) {
				if (isset($_FILES['cover'])) {
					...
					if ($file_tmp == null) {
						$cover = $data['cover'];
						$script = "UPDATE buku SET judul='$judul', penerbit='$penerbit', pengarang='$pengarang', harga='$harga', tgl='$tgl', cover='$cover' WHERE book_id=$book_id";
					} else {
				...
				<div class="row">
					<div class="col-md-12">
						...
						<form method="post" enctype="multipart/form-data">
							...
							<a href="dashboard.php" type="submit" style="margin-top: 16px; background: #C9BBCF; width: 100px;" class="btn">Cancel</a>
						</form>
					</div>
				</div>
			</div>
